...
/**
 * @file common.h
 * @brief CLI utilities for OpenDXA tools
 * 
 * This header provides common CLI utilities for argument parsing, logging,
 * parallelism configuration, and file handling. Package-specific functions
 * like parseCrystalStructure() and parseIdentificationMode() are in their
 * respective packages (Structure-Identification, OpenDXA).
 */
